  ...
  return (
    ...
    >
      <div className="search-container">
        <h2 className="bg-gradient-to-b from-sky-950 to-sky-900 text-4xl text-slate-200 pt-4 h-full w-full border-b-2 rounded-t-xl border-sky-950 text-center mb-2">
          Search
        </h2>
        <section>
          <NewLocation
